        ...
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
              return const Center(child: Text("ยังไม่มีกระทู้เลย เริ่มตั้งกระทู้แรกกันเถอะ!"));
            }
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final post = postDoc.data() as Map<String, dynamic>; // แปลงข้อมูลมาใช้

                return GestureDetector(
                  onTap: (){
                    // ส่ง postDoc.id (รหัสเอกสารจริงใน Firestore) ไปหน้า Detail
                    Navigator.push(context, MaterialPageRoute(builder: (context) => PostDetail(threadId: postDoc.id)));
                  },
                  child: Card(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text("${post["comments_count"] ?? 0}"), // ดึงตัวเลขจาก DB
